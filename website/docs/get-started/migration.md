...
| [`MD014` - Dollar signs used before commands without showing output](https://github.com/DavidAnson/markdownlint/blob/main/doc/md014.md#md014---dollar-signs-used-before-commands-without-showing-output) :warning: | [`md/no-shell-dollar`](../rules/no-shell-dollar.md) |
