...
ruleTester('consistent-heading-style', rule, {
  ...
  invalid: [
    ...
    },
    {
      ...
      options: [{ style: 'setext-with-atx' }],
      errors: [
        { messageId: 'style', line: 1, data: { style: 'setext' } },
        { messageId: 'style', line: 3, data: { style: 'setext' } },
        { messageId: 'style', line: 5, data: { style: 'atx' } },
      ],
    },
    {
      ...
      errors: [
        { messageId: 'style', line: 1, data: { style: 'setext' } },
        { messageId: 'style', line: 3, data: { style: 'setext' } },
        { messageId: 'style', line: 5, data: { style: 'atx-closed' } },
      ],
    },
    {
